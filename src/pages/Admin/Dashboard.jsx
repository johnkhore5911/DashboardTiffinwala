...
//     const intervalId = setInterval(() => dispatch(fetchDashboardData()), 5000);
//     return () => clearInterval(intervalId);
//   }, [dispatch]);
  
//   const { data, upperStats, lowerStats, deliveryPartners } = useSelector(state => state.dashboard); // Replace 'dashboard' with the correct slice of state
//   // useEffect(() => {
//   //   console.log("Redux State Updated:", { data, upperStats, lowerStats, deliveryPartners });
//   // }, [data, upperStats, lowerStats, deliveryPartners]);
